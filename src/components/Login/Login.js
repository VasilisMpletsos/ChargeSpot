            ...
            <form onSubmit={sendHandler} className={classes.Login}>
                <Grid className={classes.Login} container alignItems="center" justify="center" direction="row" spacing={4}>
                    <Grid item container justify="center" xs={12}>
                        <TextField className={classes.Input}  error={errors.errorName} name="username" onChange={inputHandler} label="Username" variant="outlined" />
                    </Grid>
                    <Grid item container justify="center" xs={12}>
                        <TextField  color="primary" className={classes.Input} error={errors.errorPassword} name="password" onChange={inputHandler} type="password" label="Password" variant="outlined" />
                    </Grid>
                </Grid>
                <Box className={classes.SendBox}>
                    <Button className={classes.Sendbutton} type="submit" disabled={state.username.length === 0 || state.password.length === 0} variant="contained" color="primary" startIcon={<SendIcon/>}>Send</Button>
                </Box>
            </form>
